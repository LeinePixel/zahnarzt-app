...
describe('activateSupportAccessForCurrentPortal', () => {
  it('activates only the submitted opaque grant with a controlled support reason', async () => {
    vi.mocked(getCurrentUserContext).mockResolvedValue({
      status: 'portal_admin',
      userId: '11000000-0000-0000-0000-000000000003',
    })
    vi.mocked(createClient).mockResolvedValue({} as never)
    vi.mocked(activateSupportAccess).mockResolvedValue('2026-08-28T20:00:00Z')
