...
- **Datenschutz und Sicherheit:** Die MVP-Phase arbeitet ausschließlich mit synthetischen Daten, die Architektur wird dennoch ab Tag eins für den hohen Schutzbedarf von Patienten- und Gesundheitsdaten ausgelegt. Echte oder re-identifizierbare Daten sind bis zur Erfüllung des verbindlichen Real-Data-Gates untersagt. Maßgeblich ist `docs/architecture/privacy-security-ai-compliance.md`.
- **KI-Regulierung:** KI unterstützt Extraktion und Entwurf, trifft aber keine autonomen medizinischen oder wesentlich wirkenden Entscheidungen. Vor jeder KI-Funktion sind AI-Act-Einstufung, Transparenz, Human Oversight, Anbieterprüfung und ein möglicher Medizinproduktebezug zu dokumentieren.
